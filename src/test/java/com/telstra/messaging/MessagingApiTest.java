...
public class MessagingApiTest {
     ...
     */
    @Test
    public void retrieveMMSResponsesTest() throws ApiException {
        List<MMSContent> response = api.retrieveMMSResponses();
    ...
    public void retrieveSMSResponsesTest() throws ApiException {
        InboundPollResponse response = api.retrieveSMSResponses();
    ...
    public void sendMMSTest() throws ApiException {
        ...
        MessageSentResponse response = api.sendMMS(sendMmsRequest);
    ...
    public void sendSMSTest() throws ApiException {
        ...
        MessageSentResponse response = api.sendSMS(sendSMSRequest);
