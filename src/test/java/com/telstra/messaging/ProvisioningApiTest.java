...
public class ProvisioningApiTest {
    ...
    public void createSubscriptionTest() throws ApiException {
        ProvisionNumberRequest provisionNumberRequest = null;
        ProvisionNumberResponse response = api.createSubscription(provisionNumberRequest);
    ...
    public void deleteSubscriptionTest() throws ApiException {
        DeleteNumberRequest deleteNumberRequest = null;
        api.deleteSubscription(deleteNumberRequest);
