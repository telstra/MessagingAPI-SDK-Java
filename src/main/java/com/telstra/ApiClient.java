...
import com.telstra.auth.HttpBearerAuth;
import com.telstra.auth.ApiKeyAuth;
import com.telstra.auth.OAuth;
import com.telstra.auth.RetryingOAuth;
import com.telstra.auth.OAuthFlow;
...
public class ApiClient {
    ...
    public ApiClient(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        RetryingOAuth retryingOAuth = new RetryingOAuth("https://tapi.telstra.com/v2/oauth/token", clientId, OAuthFlow.application, clientSecret, parameters);
        authentications.put(
                "auth",
                retryingOAuth
        );
