...
public class TelstraMessagingAPIClient {
    /**
     * Singleton access to Provisioning controller
     * @return	Returns the ProvisioningController instance 
     */
    public ProvisioningController getProvisioning() {
        return ProvisioningController.getInstance();
    }
