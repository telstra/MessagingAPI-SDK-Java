...
public class OAuthAuthorizationController extends BaseController {    
    ...
    public void createRequestTokenAsync(
        ...
        String _baseUri = Configuration.getBaseUri(Servers.ACCESS_TOKEN_SERVER);
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4829676657813042672L;
            {
        ...
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5734729569695835187L;
            {
