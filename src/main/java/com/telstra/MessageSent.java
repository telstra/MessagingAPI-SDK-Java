...
public class MessageSent {
  ...
  **/
   ...
   * @return scheduleSend
  **/
  @Schema(description = "The time (in Central Standard Time) the message is scheduled to send.")
  ...
  **/
  @Schema(description = "If set to **true**, you will receive a notification to the statusCallbackUrl when your SMS is delivered (paid feature).")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.messageId, messageSent.messageId) &&
        ...
        Objects.equals(this.deliveryNotification, messageSent.deliveryNotification) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(messageId, status, to, from, messageContent, multimedia, retryTimeout, scheduleSend, deliveryNotification, statusCallbackUrl, tags);
  }
