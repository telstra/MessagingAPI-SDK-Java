...
public class MessageSentResponse {
  ...
  public static final String SERIALIZED_NAME_NUMBER_NATIONAL_DESTINATIONS = "NumberNationalDestinations";
  @SerializedName(SERIALIZED_NAME_NUMBER_NATIONAL_DESTINATIONS)
  private Integer numberNationalDestinations = null;

  public static final String SERIALIZED_NAME_NUMBER_INTERNATIONAL_DESTINATIONS = "NumberInternationalDestinations";
  @SerializedName(SERIALIZED_NAME_NUMBER_INTERNATIONAL_DESTINATIONS)
  ...
  **/
  @ApiModelProperty(example = "1", required = true, value = "For SMS messages only, the value indicates the number of 160 character message segments sent.")
  ...
  **/
  @ApiModelProperty(example = "1", value = "This returns the number of domestic Australian messages sent.")
  ...
  **/
  @ApiModelProperty(example = "0", value = "This returns the number of international messages sent")
